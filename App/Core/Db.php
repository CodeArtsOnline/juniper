...
class Db extends Core
{
	...
	public function initialise()
	{
		...
		$this->host = $this->singleton('core/config')->getDatabaseHost();
		$this->username = $this->singleton('core/config')->getDatabaseUser();
		$this->password = $this->singleton('core/config')->getDatabasePass();
		$this->db = $this->singleton('core/config')->getDatabaseDatabase();
		$this->port = $this->singleton('core/config')->getDatabasePort();
		$this->charset = "utf8";
